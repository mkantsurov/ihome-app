...
public class MeasurementLogEntryRowMapper implements RowMapper<MeasurementLogEntity> {
    ...
    public MeasurementLogEntity mapRow(ResultSet rs, int rowNum) throws SQLException {
        return new MeasurementLogEntity(
                ...
                rs.getInt("ext_pwr_current"),
                rs.getInt("ext_pwr_frequency"),
                rs.getInt("ext_pwr_consumption"),
                rs.getInt("int_pwr_voltage"),
                rs.getInt("int_pwr_current"),
                rs.getInt("int_pwr_frequency"),
                rs.getInt("int_pwr_consumption"),
                rs.getInt("int_bck_pwr_voltage"),
                rs.getInt("int_bck_pwr_current"),
                rs.getInt("int_bck_pwr_frequency"),
                rs.getInt("int_bck_pwr_consumption"),
