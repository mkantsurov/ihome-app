 ...
 **/
public class BinaryInputInitiatedHwEvent implements IHomeEvent {
    ...
    public BinaryInputInitiatedHwEvent(long portId, MegadPortType portType, ControllerEventInfo eventInfo) {
        this.portId = portId;
